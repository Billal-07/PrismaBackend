...
import { PrismaClient, Prisma, Doctor,
...
export type ModelTypes<T = unknown> = {
  doctor: {
    ...
    Include: unknown;
    Create: Prisma.DoctorCreateInput | Prisma.DoctorUncheckedCreateInput;
    Update: Prisma.DoctorUpdateInput | Prisma.DoctorUncheckedUpdateInput;
    Cursor: Prisma.DoctorWhereUniqueInput;
    Order: Prisma.DoctorOrderByWithRelationInput;
    Delegate: Prisma.DoctorDelegate<ModelDelegate>;
    GroupBy: Prisma.DoctorGroupByOutputType;
    // @ts-ignore
    Return: Prisma.DoctorGetPayload<T>;
  },
  user: {
